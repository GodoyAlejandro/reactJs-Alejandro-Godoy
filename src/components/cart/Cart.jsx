...
function Cart({ clear, removeItem, total, cartItem}) {
  return (
    ...
    <Paper elevation={3} sx={{ width: "50rem" }}>
      ...
      <CardActions sx={{display:'flex', flexDirection:'row', justifyContent:'flex-end', padding:'1rem', height:'5rem'}}>
        {total === 0 ? <Typography /> : <Typography variant='h4' sx={{fontWeight:'500'}}>Total: ${total}</Typography>}
